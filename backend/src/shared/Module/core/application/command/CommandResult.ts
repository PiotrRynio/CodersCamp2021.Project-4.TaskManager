...
export namespace CommandResult {
  ...
  export const success: (value?: any) => CommandResult.Success = (value: any = undefined) =>
    new Success(value);

  export const failureDueTo: (reason?: Error) => CommandResult.Failure = (
    reason: Error = new Error('Unknown error.'),
  ) => new Failure(reason);
